...
export default function ListingDetail() {
  ...
  const { user } = useAuth();
  const { openConversationThread } = useChatWidget();
            ...
            <>
              {listing.status === 'available' && (
                <div className="contact-actions">
                  {user ? (
                    <button
                      className="contact-seller-btn chat-btn"
                    ...
                    <Link to="/login" className="contact-seller-btn chat-btn">
                  ...
                  {listing.seller?.phone && (
                    ...
                    >
                      or contact on WhatsApp instead
                    </a>
                  )}
                </div>
              )}
